...
describe('BodyText Specs', function () {
  test('should render a single <p> tag', function () {
    ...
    var bodyText = (0, _enzyme.mount)( /*#__PURE__*/(0, _jsxRuntime.jsx)(_BodyText["default"], {
      children: msg
    }));
  ...
  test('should render BodyText with content', function () {
    ...
    var bodyTextTag = (0, _enzyme.mount)( /*#__PURE__*/(0, _jsxRuntime.jsx)(_BodyText["default"], {
      children: content
    }));
  ...
  test('should not include the centered class by default', function () {
    var subject = (0, _enzyme.shallow)( /*#__PURE__*/(0, _jsxRuntime.jsx)(_BodyText.BodyTextBase, {}));
    var expected = false;
