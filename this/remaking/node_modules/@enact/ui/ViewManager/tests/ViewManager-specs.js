...
describe('ViewManager', function () {
  ...
  test('should render {component} as its child - <div/> by default', function () {
    var subject = (0, _enzyme.mount)( /*#__PURE__*/(0, _jsxRuntime.jsx)(_["default"], {
  ...
  test('should render only 1 child view', function () {
    var subject = (0, _enzyme.mount)( /*#__PURE__*/(0, _jsxRuntime.jsxs)(_["default"], {
      children: [/*#__PURE__*/(0, _jsxRuntime.jsx)("div", {
        className: "view",
        children: "View 1"
  ...
  test('should allow child props to update', function () {
    ...
    var subject = (0, _enzyme.mount)( /*#__PURE__*/(0, _jsxRuntime.jsx)(ViewManagerTest, {
      content: "original"
    }));
    subject.setProps({
      content: content
  ...
  it('should not receive onTransition event on mount', function () {
    var spy = jest.fn();
    (0, _enzyme.mount)( /*#__PURE__*/(0, _jsxRuntime.jsxs)(_["default"], {
      index: 0,
      onTransition: spy,
      noAnimation: true,
      children: [/*#__PURE__*/(0, _jsxRuntime.jsx)("div", {
