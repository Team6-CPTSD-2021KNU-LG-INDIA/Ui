...
describe('Router', function () {
  ...
  test('should render a single component matching the {path}', function () {
    var subject = (0, _enzyme.shallow)( /*#__PURE__*/(0, _jsxRuntime.jsx)(_Router.RouterBase, {
      routes: routes,
      path: "/app"
    }));
    var expected = 1;
  ...
  test('should render children into {component}', function () {
    ...
    var subject = (0, _enzyme.mount)( /*#__PURE__*/(0, _jsxRuntime.jsx)(_Router.Router, {
      routes: routes,
      path: "/app/settings",
      component: component
    }));
  ...
  test('should render an array of components matching the {path} using JSX routes', function () {
    var subject = (0, _enzyme.mount)( /*#__PURE__*/(0, _jsxRuntime.jsxs)(_Router.Router, {
      path: "/app/home",
