...
exports.InputDecorator = exports.InputPopupBase = exports.InputPopup = exports.InputBase = exports.Input = exports["default"] = void 0;
...
var isPasswordType = function isPasswordType(type) {
  return type === 'password' || type === 'passwordnumber';
};
/**
...
var InputPopupBase = (0, _kind["default"])({
  ...
  /** @lends sandstone/Input.InputPopupBase.prototype */
  {
     ...
     * @public
     */
    type: _propTypes["default"].oneOf(['text', 'password', 'number', 'passwordnumber', 'url']),
  ...
  handlers: {
    onShow: (0, _handle.handle)((0, _handle.forward)('onShow'), function (ev, _ref) {
      var type = _ref.type;
    ...
    }, (0, _handle.adaptEvent)(prepareInputEventPayload, (0, _handle.forward)('onComplete')), (0, _handle.forward)('onClose'))
  },
  computed: {
  ...
  render: function render(_ref6) {
    var announce = _ref6.announce,
        ...
        rest = _objectWithoutProperties(_ref6, ["announce", "backButtonAriaLabel", "children", "css", "inputFieldSpotlightId", "noBackButton", "noSubmitButton", "numberInputField", "onBeforeChange", "onClose", "onNumberComplete", "onInputKeyDown", "onShow", "open", "placeholder", "popupAriaLabel", "popupClassName", "popupType", "size", "subtitle", "title", "type", "value", "maxLength", "minLength"]);
...
var InputBase = (0, _kind["default"])({
  ...
  render: function render(_ref9) {
    var announce = _ref9.announce,
        ...
        style = _ref9.style,
        rest = _objectWithoutProperties(_ref9, ["announce", "buttonAriaLabel", "buttonLabel", "type", "size", "disabled", "value", "placeholder", "onClick", "className", "style"]);
