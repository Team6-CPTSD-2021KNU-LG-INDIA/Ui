...
exports.WizardPanelsDecorator = exports.WizardPanelsContext = exports.WizardPanelsBase = exports.WizardPanels = exports["default"] = void 0;
...
var WizardPanelsBase = (0, _kind["default"])({
  ...
  handlers: {
    onNextClick: (0, _handle["default"])((0, _handle.forwardWithPrevent)('onNextClick'), function (ev, _ref) {
    ...
    onPrevClick: (0, _handle["default"])((0, _handle.forwardWithPrevent)('onPrevClick'), function (ev, _ref2) {
  ...
  render: function render(_ref8) {
    var ariaLabel = _ref8['aria-label'],
        ...
        rest = _objectWithoutProperties(_ref8, ["aria-label", "children", "footer", "index", "nextButton", "nextButtonVisibility", "noAnimation", "onNextClick", "onPrevClick", "onTransition", "onWillTransition", "prevButton", "prevButtonVisibility", "reverseTransition", "steps", "subtitle", "title", "totalPanels"]);
...
function useReverseTransition() {
  ...
  var _useState3 = (0, _react.useState)(rtl),
...
var WizardPanelsRouter = function WizardPanelsRouter(Wrapped) {
  var WizardPanelsProvider = function WizardPanelsProvider(_ref9) {
    var children = _ref9.children,
        ...
        title = _ref9.title,
        rtl = _ref9.rtl,
        rest = _objectWithoutProperties(_ref9, ["children", "componentRef", "data-spotlight-id", "index", "noAnimation", "onTransition", "onWillTransition", "title", "rtl"]);

    var _useState5 = (0, _react.useState)(null),
        _useState6 = _slicedToArray(_useState5, 2),
        panel = _useState6[0],
        setPanel = _useState6[1];
    ...
    var reverseTransition = useReverseTransition(index, rtl);
    ...
    var _useFocusOnTransition = (0, _useFocusOnTransition2["default"])({
      ...
      spotlightId: spotlightId
        ...
        transition = _objectWithoutProperties(_useFocusOnTransition, ["onWillTransition"]);
    ...
    var currentTitle = panel && panel.title ? panel.title : title; // eslint-disable-next-line enact/prop-types
...
var WizardPanelsDecorator = (0, _compose["default"])((0, _ForwardRef["default"])({
  ...
  cancel: 'onChange',
  shouldCancel: (0, _handle["default"])((0, _handle.forwardWithPrevent)('onBack'), (0, _handle.not)((0, _handle.forProp)('noPrevButton', true)))
