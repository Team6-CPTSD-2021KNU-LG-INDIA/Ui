...
var SliderBase = function SliderBase(props) {
  ...
  var active = props.active,
      ...
      rest = _objectWithoutProperties(props, ["active", "className", "css", "disabled", "focused", "keyFrequency", "showAnchor"]);
  ...
  var nativeEventHandlers = (0, _useHandlers["default"])({
    onWheel: (0, _handle.handle)((0, _handle.forProp)('disabled', false), (0, _handle.forwardWithPrevent)('onWheel'), (0, _anyPass["default"])([_utils.handleIncrementByWheel, _utils.handleDecrementByWheel]))
  }, props, context); // if the props includes a css map, merge them together

  var mergedCss = _SliderModule["default"];

  if (css) {
    var allowedClassNames = Object.keys(_SliderModule["default"]);
    mergedCss = (0, _util.mergeClassNameMaps)(_SliderModule["default"], css, allowedClassNames);
  }
