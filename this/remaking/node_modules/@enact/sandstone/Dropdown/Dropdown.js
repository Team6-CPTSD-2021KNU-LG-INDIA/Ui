...
var DropdownButtonBase = (0, _kind["default"])({
  ...
  render: function render(_ref) {
    var forwardRef = _ref.forwardRef,
        props = _objectWithoutProperties(_ref, ["forwardRef"]);
...
var DropdownBase = (0, _kind["default"])({
  ...
  handlers: {
    ...
    onOpen: (0, _handle.handle)((0, _handle.forward)('onClick'), (0, _handle.not)((0, _handle.forProp)('disabled', true)), (0, _handle.not)((0, _handle.forProp)('open', true)), (0, _handle.forward)('onOpen'))
  },
  styles: {
    css: _DropdownModule["default"],
    className: 'dropdown'
