...
describe('Picker Specs', function () {
  test('should have a default \'value\' of 0', function () {
    var picker = (0, _enzyme.mount)( /*#__PURE__*/(0, _jsxRuntime.jsx)(_Picker["default"], {
      index: 0,
      max: 0,
      min: 0
    }));
  ...
  test('indicator Container should not show any indicator when \'joined\' and \'horizontal\' and has no children', function () {
    ...
    var expected = 0;
    var actual = picker.find(".".concat(_PickerModule["default"].indicator)).length;
    expect(actual).toBe(expected);
  });
  ...
  test('indicator Container should show with the exact number of children indicator when \'joined\' and \'horizontal\'', function () {
    var picker = (0, _enzyme.mount)( /*#__PURE__*/(0, _jsxRuntime.jsxs)(_Picker["default"], {
      index: 0,
      max: 2,
      min: 0,
      joined: true,
  ...
  describe('accessibility', function () {
    ...
    test('should set the aria-valuetext attribute properly to read it when changing the value', function () {
      ...
      var expected = '2';
      var actual = picker.find(".".concat(_PickerModule["default"].valueWrapper)).first().prop('aria-valuetext');
      expect(actual).toBe(expected);
    });
    test('should have aria-hidden=true when \'joined\' and not active', function () {
      ...
      var expected = true;
      var actual = picker.find(".".concat(_PickerModule["default"].valueWrapper)).first().prop('aria-hidden');
      expect(actual).toBe(expected);
    });
    ...
    test('should set "aria-label" to joined picker', function () {
      ...
      var expected = label;
      var actual = picker.find(".".concat(_PickerModule["default"].valueWrapper)).first().parent().prop('aria-label');
      expect(actual).toBe(expected);
    });
  });
});