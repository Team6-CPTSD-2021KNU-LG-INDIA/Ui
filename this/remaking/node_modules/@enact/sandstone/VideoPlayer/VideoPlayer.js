...
var VideoPlayerBase = (_temp = _class = /*#__PURE__*/function (_Component) {
  ...
  function VideoPlayerBase(_props) {
    ...
    _this.onSliderChange = function (_ref10) {
    ...
    _this.handleToggleMore = function (ev) {
      ...
      _this.player.style.setProperty('--liftDistance', "".concat(liftDistance, "px"));

      _this.setState(function (_ref11) {
        var announce = _ref11.announce;
        return {
    ...
    _this.jumpButtonPressed = null; // Re-render-necessary State
  ...
  _createClass(VideoPlayerBase, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          mediaProps = _objectWithoutProperties(_this$props, ["className", "disabled", "infoComponents", "initialJumpDelay", "jumpDelay", "loading", "locale", "mediaControlsComponent", "no5WayJump", "noAutoPlay", "noMiniFeedback", "noSlider", "noSpinner", "selection", "spotlightDisabled", "spotlightId", "style", "thumbnailComponent", "thumbnailSrc", "title", "videoComponent"]);
