...
.titleFrame:global(.neutral) .titleFrame .redIcon {
...
:global(.enact-a11y-high-contrast) .titleFrame:global(.neutral):global(.highContrast) .titleFrame .redIcon {
  background-color: transparent;
  color: #fe4a4b;
}
...
.titleFrame:global(.light) .titleFrame .redIcon {
  background-color: transparent;
  color: #fe4a4b;
}
