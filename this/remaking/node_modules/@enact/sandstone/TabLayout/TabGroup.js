...
exports.TabGroup = exports["default"] = void 0;
...
var TabButton = function TabButton(_ref) {
  var buttonSize = _ref.buttonSize,
      rest = _objectWithoutProperties(_ref, ["buttonSize"]);
...
var TabBase = (0, _kind["default"])({
  ...
  handlers: {
    onClick: (0, _handle["default"])((0, _handle.forward)('onClick'), (0, _handle.not)((0, _handle.forProp)('disabled', true)), (0, _handle.adaptEvent)(function (ev, _ref2) {
      var index = _ref2.index;
      return {
        selected: index
      };
    }, (0, _handle.forward)('onTabClick'))),
    ...
    }, (0, _handle.adaptEvent)(function (ev, _ref3) {
      var index = _ref3.index;
      return {
        selected: index
      };
    }, (0, _handle.forward)('onFocusTab')))
  },
  computed: {
  ...
  render: function render(_ref6) {
    var children = _ref6.children,
        ...
        size = _ref6.size,
        rest = _objectWithoutProperties(_ref6, ["children", "collapsed", "css", "orientation", "size"]);
...
var TabGroupBase = (0, _kind["default"])({
  ...
  render: function render(_ref11) {
    var collapsed = _ref11.collapsed,
        ...
        rest = _objectWithoutProperties(_ref11, ["collapsed", "noIcons", "onBlur", "onBlurList", "onFocus", "onFocusTab", "onSelect", "orientation", "selectedIndex", "spotlightId", "spotlightDisabled", "tabs", "tabSize", "tabsDisabled", "tabsSpotlightDisabled"]);
    ...
    }, [collapsed, orientation, tabSize]); // eslint-disable-next-line react-hooks/rules-of-hooks
      ...
      return tabs.map(function (tab) {
        if (tab) {
          ...
          var icon = tab.icon,
              ...
              tabKey = tab.tabKey,
              sprite = tab.sprite,
              _rest = _objectWithoutProperties(tab, ["icon", "title", "tabKey", "sprite"]);
