...
exports.TabLayoutDecorator = exports.TabLayoutContext = exports.TabLayoutBase = exports.TabLayout = exports["default"] = void 0;
...
var TabLayoutBase = (0, _kind["default"])({
  ...
  handlers: {
    onKeyDown: function onKeyDown(ev, props) {
      ...
      if ((0, _handle.forwardWithPrevent)('onKeyDown', ev, props) && direction && collapsed && orientation === 'vertical' && document.querySelector("[data-spotlight-id='".concat(spotlightId, "']")).contains(target)) {
    ...
    onSelect: (0, _handle.handle)((0, _handle.adaptEvent)(function (_ref) {
  ...
  render: function render(_ref10) {
    var children = _ref10.children,
        ...
        tabs = _ref10.tabs,
        type = _ref10.type,
        rest = _objectWithoutProperties(_ref10, ["children", "collapsed", "css", "data-spotlight-id", "dimensions", "handleClick", "handleEnter", "handleFlick", "handleFocus", "handleTabsTransitionEnd", "index", "onCollapse", "onSelect", "orientation", "tabOrientation", "tabSize", "tabs", "type"]);
