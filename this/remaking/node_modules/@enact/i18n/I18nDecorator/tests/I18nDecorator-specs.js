...
describe('I18nDecorator', function () {
  ...
  test('should add rtl context parameter', function () {
    ...
    var subject = (0, _enzyme.mount)( /*#__PURE__*/(0, _jsxRuntime.jsx)(Wrapped, {}));
  ...
  test('should set locale via props', function () {
    ...
    (0, _enzyme.shallow)( /*#__PURE__*/(0, _jsxRuntime.jsx)(Wrapped, {
      locale: "ar-SA"
    }));
    var expected = 'ar-SA';
  ...
  test('should add locale classes to Wrapped', function () {
    ...
    var subject = (0, _enzyme.shallow)( /*#__PURE__*/(0, _jsxRuntime.jsx)(Wrapped, {
      locale: "en-US"
    })).find(Component);
    var expected = true;
