...
describe('useSpottable', function () {
  function SpottableBase(props) {
    var className = props.className,
        ...
        rest = _objectWithoutProperties(props, ["className", "component", "componentRef", "disabled", "emulateMouse", "onSelectionCancel", "onSpotlightDisappear", "onSpotlightDown", "onSpotlightLeft", "onSpotlightRight", "onSpotlightUp", "selectionKeys", "spotlightDisabled", "spotlightId"]);
  ...
  test('should add the spottable class', function () {
    var subject = (0, _enzyme.mount)( /*#__PURE__*/(0, _jsxRuntime.jsx)(SpottableComponent, {}));
